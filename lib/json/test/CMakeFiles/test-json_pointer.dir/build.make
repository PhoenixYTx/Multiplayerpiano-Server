...
test/CMakeFiles/test-json_pointer.dir/src/unit-json_pointer.cpp.o: test/src/unit-json_pointer.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir="/media/ryan/New Volume/multiplayerpiano-server/lib/json/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/test-json_pointer.dir/src/unit-json_pointer.cpp.o"
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-json_pointer.dir/src/unit-json_pointer.cpp.o -c "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-json_pointer.cpp"
...
test/CMakeFiles/test-json_pointer.dir/src/unit-json_pointer.cpp.i: cmake_force
	...
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-json_pointer.cpp" > CMakeFiles/test-json_pointer.dir/src/unit-json_pointer.cpp.i
...
test/CMakeFiles/test-json_pointer.dir/src/unit-json_pointer.cpp.s: cmake_force
	...
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-json_pointer.cpp" -o CMakeFiles/test-json_pointer.dir/src/unit-json_pointer.cpp.s
...
test/test-json_pointer: test/CMakeFiles/test-json_pointer.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir="/media/ryan/New Volume/multiplayerpiano-server/lib/json/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test-json_pointer"
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-json_pointer.dir/link.txt --verbose=$(VERBOSE)
...
test/CMakeFiles/test-json_pointer.dir/clean:
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && $(CMAKE_COMMAND) -P CMakeFiles/test-json_pointer.dir/cmake_clean.cmake
