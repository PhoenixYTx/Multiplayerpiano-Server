...
test/CMakeFiles/test-deserialization.dir/src/unit-deserialization.cpp.o: test/src/unit-deserialization.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir="/media/ryan/New Volume/multiplayerpiano-server/lib/json/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/test-deserialization.dir/src/unit-deserialization.cpp.o"
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-deserialization.dir/src/unit-deserialization.cpp.o -c "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-deserialization.cpp"
...
test/CMakeFiles/test-deserialization.dir/src/unit-deserialization.cpp.i: cmake_force
	...
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-deserialization.cpp" > CMakeFiles/test-deserialization.dir/src/unit-deserialization.cpp.i
...
test/CMakeFiles/test-deserialization.dir/src/unit-deserialization.cpp.s: cmake_force
	...
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-deserialization.cpp" -o CMakeFiles/test-deserialization.dir/src/unit-deserialization.cpp.s
...
test/test-deserialization: test/CMakeFiles/test-deserialization.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir="/media/ryan/New Volume/multiplayerpiano-server/lib/json/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test-deserialization"
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-deserialization.dir/link.txt --verbose=$(VERBOSE)
...
test/CMakeFiles/test-deserialization.dir/clean:
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && $(CMAKE_COMMAND) -P CMakeFiles/test-deserialization.dir/cmake_clean.cmake
