...
test/CMakeFiles/test-comparison.dir/src/unit-comparison.cpp.o: test/src/unit-comparison.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir="/media/ryan/New Volume/multiplayerpiano-server/lib/json/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/test-comparison.dir/src/unit-comparison.cpp.o"
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-comparison.dir/src/unit-comparison.cpp.o -c "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-comparison.cpp"
...
test/CMakeFiles/test-comparison.dir/src/unit-comparison.cpp.i: cmake_force
	...
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-comparison.cpp" > CMakeFiles/test-comparison.dir/src/unit-comparison.cpp.i
...
test/CMakeFiles/test-comparison.dir/src/unit-comparison.cpp.s: cmake_force
	...
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-comparison.cpp" -o CMakeFiles/test-comparison.dir/src/unit-comparison.cpp.s
...
test/test-comparison: test/CMakeFiles/test-comparison.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir="/media/ryan/New Volume/multiplayerpiano-server/lib/json/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test-comparison"
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-comparison.dir/link.txt --verbose=$(VERBOSE)
...
test/CMakeFiles/test-comparison.dir/clean:
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && $(CMAKE_COMMAND) -P CMakeFiles/test-comparison.dir/cmake_clean.cmake
