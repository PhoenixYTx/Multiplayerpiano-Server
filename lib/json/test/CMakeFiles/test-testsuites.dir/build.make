...
test/CMakeFiles/test-testsuites.dir/src/unit-testsuites.cpp.o: test/src/unit-testsuites.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir="/media/ryan/New Volume/multiplayerpiano-server/lib/json/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/test-testsuites.dir/src/unit-testsuites.cpp.o"
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-testsuites.dir/src/unit-testsuites.cpp.o -c "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-testsuites.cpp"
...
test/CMakeFiles/test-testsuites.dir/src/unit-testsuites.cpp.i: cmake_force
	...
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-testsuites.cpp" > CMakeFiles/test-testsuites.dir/src/unit-testsuites.cpp.i
...
test/CMakeFiles/test-testsuites.dir/src/unit-testsuites.cpp.s: cmake_force
	...
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-testsuites.cpp" -o CMakeFiles/test-testsuites.dir/src/unit-testsuites.cpp.s
...
test/test-testsuites: test/CMakeFiles/test-testsuites.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir="/media/ryan/New Volume/multiplayerpiano-server/lib/json/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test-testsuites"
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-testsuites.dir/link.txt --verbose=$(VERBOSE)
...
test/CMakeFiles/test-testsuites.dir/clean:
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && $(CMAKE_COMMAND) -P CMakeFiles/test-testsuites.dir/cmake_clean.cmake
