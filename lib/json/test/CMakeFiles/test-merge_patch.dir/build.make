...
test/CMakeFiles/test-merge_patch.dir/src/unit-merge_patch.cpp.o: test/src/unit-merge_patch.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir="/media/ryan/New Volume/multiplayerpiano-server/lib/json/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/test-merge_patch.dir/src/unit-merge_patch.cpp.o"
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-merge_patch.dir/src/unit-merge_patch.cpp.o -c "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-merge_patch.cpp"
...
test/CMakeFiles/test-merge_patch.dir/src/unit-merge_patch.cpp.i: cmake_force
	...
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-merge_patch.cpp" > CMakeFiles/test-merge_patch.dir/src/unit-merge_patch.cpp.i
...
test/CMakeFiles/test-merge_patch.dir/src/unit-merge_patch.cpp.s: cmake_force
	...
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test/src/unit-merge_patch.cpp" -o CMakeFiles/test-merge_patch.dir/src/unit-merge_patch.cpp.s
...
test/test-merge_patch: test/CMakeFiles/test-merge_patch.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir="/media/ryan/New Volume/multiplayerpiano-server/lib/json/CMakeFiles" --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test-merge_patch"
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-merge_patch.dir/link.txt --verbose=$(VERBOSE)
...
test/CMakeFiles/test-merge_patch.dir/clean:
	cd "/media/ryan/New Volume/multiplayerpiano-server/lib/json/test" && $(CMAKE_COMMAND) -P CMakeFiles/test-merge_patch.dir/cmake_clean.cmake
